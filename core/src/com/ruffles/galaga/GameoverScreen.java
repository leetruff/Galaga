...
//		highscoreScore3 = 5122;
	...
	public void render(float delta) {
		...
		if(highscoreName1 != "-1"){
			scoreFont.draw(batch, highscoreName1, 85, 450);
			scoreFont.draw(batch, highscoreScore1 + "", 325, 450);
			
		}
		scoreFont.draw(batch, "-", 230, 450);
		batch.draw(goldmedal, 55, 427);
		
		if(highscoreName2 != "-1"){
			scoreFont.draw(batch, highscoreName2, 85, 400);
			scoreFont.draw(batch, highscoreScore2 + "", 325, 400);
			
		}
		scoreFont.draw(batch, "-", 230, 400);
		batch.draw(silvermedal, 55, 377);
		
		if(highscoreName3 != "-1"){
			scoreFont.draw(batch, highscoreName3, 85, 350);
			scoreFont.draw(batch, highscoreScore3 + "", 325, 350);
			
		}
		scoreFont.draw(batch, "-", 230, 350);
		batch.draw(bronzemedal, 55, 327);
		
		
		
		scoreFont.draw(batch, "Final Score:", 150, 550);
		
		
		if(score < 100){
			scoreFont.draw(batch, score + "", 195, 510);
		}
		
		else if(score < 1000){
		scoreFont.draw(batch, score + "", 185, 510);
		}
		
		else if(score < 10000){
		scoreFont.draw(batch, score + "", 180, 510);
		}
		
		else if(score < 100000){
		scoreFont.draw(batch, score + "", 174, 510);
		}
